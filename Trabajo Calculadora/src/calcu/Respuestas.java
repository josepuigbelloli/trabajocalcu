...
public class Respuestas {
	...
	/* 5)
	Surge un error en el segundo push,  al no tener el repositorio actualizado
	con los últimos commit enviados por el otro grupo. 
    Antes de esta acción se debe ejecutar el comando “git pull”, 
	que obtiene todos los últimos cambios del repositorio y hace
	un merge con nuestro directorio de trabajo.
	*/
	
	/* 6)
	El parametro -b crea una nueva rama llamada "develop" y se posiciona sobre la misma.
	*/
